...
- **2. test_idea** — `invention_loop`
  - round_1
    ...
    - `3_gen_art/` — 2 task(s)
      ...
      - `chat/prompts/2_test_idea/round_1/3_gen_art/gen_art_research_1.md` — 8 prompts
  ...
  - round_2
    ...
    - `2_gen_plan/` — 3 task(s)
      ...
      - `chat/prompts/2_test_idea/round_2/2_gen_plan/gen_plan_research_1.md` — 6 prompts
    - `3_gen_art/` — 3 task(s)
      ...
      - `chat/prompts/2_test_idea/round_2/3_gen_art/gen_art_research_1.md` — 6 prompts
    - `chat/prompts/2_test_idea/round_2/4_gen_paper_text.md` — 2 prompts
